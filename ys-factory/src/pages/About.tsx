            ...
            <Box sx={{p: 2}}>
                ...
                <Box sx={{p: 1}}>
                    <section id="biography">
                        ...
                        <Typography variant='h6' className='subheading'>生まれと学びの地、技術者としての礎</Typography>
                        ...
                        <p>大学卒業後の2019年、私は株式会社日立社会情報サービスに入社。官公庁系システム開発を中心に担当しながら、情報処理安全確保支援士試験にも合格しました。ICカードを使用した個人認証システムの開発・保守、SwiftによるmacOSクライアントアプリケーション開発、JavaScriptでのブラウザ拡張機能開発、Javaを用いたWebアプリケーションの保守と、多岐にわたるプロジェクトに関わりました。</p>

                        <Typography variant='h6' className='subheading'>新たな挑戦とキャリアの発展</Typography>
                        <p>2022年、キャリアの次なるステップとして株式会社フレクトに転職。SalesforceやMuleSoftの研修を経て、大手航空会社の基幹システム開発プロジェクトに参画しました。クラウドを中心とした業務の中でAWS Cloud PractitionerおよびMuleSoft Certified Developer Level1の資格を取得しました。続く2023年には、大手水処理専業会社の社内アプリケーションPoCプロジェクトにてReactを用いたフロントエンド開発を担当し、その後、大手電力会社のプロジェクトでFlutterを用いたフロントエンド開発にも挑戦しました。</p>

                        <Typography variant='h6' className='subheading'>現在と未来への展望</Typography>
                        <p>
                            現在、私はフリーランスとしての転向を視野に入れ、個人の開発プロジェクトにも力を入れています。
                            その一環として、「繋がらないSNS EchoNor」の開発に情熱を注いでおり、
                            「自分が使いたい」と思えるサービスを作り上げることを目標に自身の集大成として挑戦しています。
                            この道は孤独でありながらも、自分だけのサービスを創出する喜びに満ちています。
                            EchoNorを通じ、デジタル社会の新たなコネクションの形を築き、人々の生活に静かな共鳴をもたらすことを願っています。
                        </p>
                    </section>
                </Box>
            </Box>
